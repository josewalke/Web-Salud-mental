...
import { Brain, ChevronLeft, ChevronRight, Info, X, CheckCircle } from 'lucide-react';
...
const PersonalityQuestionnairePage: React.FC = () => {
  // Usar la configuración centralizada del cuestionario de personalidad
  const questions = getQuestions('personalidad');
  ...
  const {
    ...
    handleSubmit,
    resetQuestionnaire
  } = useQuestionnaire({ type: 'personalidad', questions });
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <p className="text-gray-600 mb-6">
            Gracias por completar el cuestionario de personalidad dinámica social. 
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Descubre tu perfil de personalidad dinámica social
          </p>
        </div>
